    ...
    AppComponent.prototype.initIoConnection = function () {
        ...
        this.socketService.onMessage().subscribe(function (message) {
            if (message.data !== undefined && message.data !== null) {
                JSON.parse(message.data).forEach(function (stock) {
                    var find = _this.stocks.find(function (x) { return x.name === stock[0]; });
                    if (!find) {
                        find = new Stock();
                        find.bestPrice = Number(stock[1]);
                        _this.stocks.push(find);
                    }
                    find.name = stock[0];
...
/* harmony import */ var ngx_timeago__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ngx-timeago */ "./node_modules/ngx-timeago/fesm5/ngx-timeago.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SocketService = /** @class */ (function () {
    ...
    SocketService.prototype.onMessage = function () {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"](function (observer) {
            _this.socket.onmessage = function (data) { return observer.next(data); };
        });
    };
...
module.exports = __webpack_require__(/*! D:\Experiments\stock\src\main.ts */"./src/main.ts");
